...
<div class="row">
    <div class="card mx-auto">
        ...
        <form method="GET" action="{{ route('testimonial.index', $lang) }}" class="mx-auto mt-3 row gy-2 gx-3 align-items-center">
          <div class="col-auto">
          ...
          <a href="{{ route('testimonial.create', $lang) }}" class="btn bg-info text-white">Create</a>
        </form>
                ...
                <tbody>
                  @foreach ($testimonials as $testimonial)
                    <tr>
                        ...
                        <td>
                          <a href="{{ route('testimonial.edit', [$lang, $testimonial->id]) }}" class="btn btn-success btn-sm">Edit</a>
                        </td>
                    </tr>
                  @endforeach
                </tbody>
...
<div class="row">
    <div class="card mx-auto">
        ...
        <form method="GET" action="{{ route('testimonial.index', $lang) }}" class="mx-auto mt-3 row gy-2 gx-3 align-items-center">
          ...
          <a href="{{ route('testimonial.create', $lang) }}" class="btn bg-info text-white">جدید</a>
        </form>
                ...
                <tbody>
                  @foreach ($testimonials as $testimonial)
                    <tr>
                        ...
                        <td>
                          <a href="{{ route('testimonial.edit', [$lang, $testimonial->id]) }}" class="btn btn-success btn-sm">ویرایش</a>
                        </td>
                    </tr>
                  @endforeach
                </tbody>
