...
<div class="row">
  <div class="card mx-auto">
      ...
      <form method="GET" action="{{ route('portfolio.index', $lang) }}" class="mx-auto mt-3 row gy-2 gx-3 align-items-center">
        <div class="col-auto">
        ...
        <a href="{{ route('portfolio.create', $lang) }}" class="btn bg-info text-white">Create</a>
      </form>
              ...
              <tbody>
                @foreach ($portfolios as $portfolio)
                  <tr>
                      ...
                      <td>
                        <a href="{{ route('portfolio.edit', [$lang,$portfolio->id]) }}" class="btn btn-success btn-sm">Edit</a>
                      </td>
                  </tr>
                @endforeach
              </tbody>
...
<div class="row">
  <div class="card mx-auto">
      ...
      <form method="GET" action="{{ route('portfolio.index', $lang) }}" class="mx-auto mt-3 row gy-2 gx-3 align-items-center">
        ...
        <a href="{{ route('portfolio.create', $lang) }}" class="btn bg-info text-white">جدید</a>
      </form>
              ...
              <tbody>
                @foreach ($portfolios as $portfolio)
                  <tr>
                      ...
                      <td>
                        <a href="{{ route('portfolio.edit', [$lang,$portfolio->id]) }}" class="btn btn-success btn-sm">ویرایش</a>
                      </td>
                  </tr>
                @endforeach
              </tbody>
