        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('portfolio.update', [$lang, $portfolio->id]) }}">
                            @csrf
                            @method('PUT')
                ...
                <form class="m-2 p-2" action="{{ route('portfolio.destroy', [$lang, $portfolio->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
